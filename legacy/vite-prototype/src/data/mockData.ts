...
export const COACH_RICKIE_LOGO =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuDmfP7tUxVfbmAL-s-DFFfvrhEJL2o-gkwNn5518BDm3OIfByts_snX2MNh6PrUm2o2o-4nYRaG7-Ku1DlraMq-21iTR3AxqvAeOr6PB0BXRsOFbb-rZxZ7MMrMkUbcBQdvppM1fMCPx9dYmoLISmUeKhPbMsiPNok_kCc9vXK_wmQSpct4RELGkdw2VmmjCf_opBrxOhLKcG3aGAAcMf7QmFEl91hbfzceg3rQJV6QoBqhizFvc6CV';

export const COACH_RICKIE_HERO =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuCRETFh3SjHo2TIIcbkiakxeLhTF7Mbq7AJMyscle9gyxIDmNTYM2kMF0PplHwmuqsv60_3zGUzuRzOXzJMMMEUkx3nQMNYrPlVlxRIYPgs3hPtPvG-shxH1p3340Y99NRSl1jwQXYkryQ5aKFZjK6YNwXHxvgiM73s2lQELfEdxdPnMKNP0qCjiTTsKpLbgmcpvOiquZRQD_VaDntmGct0unx-ijqgUIYBBgFr4880BVH2hxUoSjFi';

export const COACH_AVATAR =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuBhUZeHi3dzoN_ZgKvxACcSWJl5oo-yAxIIqZO7mduvEYaNHkV5liBzyEmKi6F0zyEFDtiBEtkiYzegHUUFTit2emagkksNUm6RXbVk-e1faNnhVYKc3ETK7fMcSZmRicFM0LpcER-SugYfhVVoDYw_okHJn9cDBhERaVp78DUeCZh1QYRyJOOBY0F9TEbwvv65C_OTn-n4S9MT_88EFVeHN7PIi6-jo4MAPKR9nrmmX9z_WiOBZ4Zq';
...
export const SERVICES: Service[] = [
  {
    ...
    description:
      'One-on-one focused session tailored to your specific mechanical and athletic goals.',
    price: 150000,
    priceLabel: 'UGX 150,000 / Session (or Plan)',
    icon: 'fitness_center',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuBgpqORRLLBSppfUkjMjdtuBrEHTG180w73bYU8WrArfFcZ1faQXDa58qua3ZcdKYcirP_UjIH1NrR5Q4Vwu7LShO9d4wW7G395aGnSaXtddVgdQjIslpEyVMT8cd0YxLOa9Vl2pBddhf8GMgLsZ_-5NJp1GUorzaKVclc2fm8XrioWsvTGGYC5dr-0nYRNArAOmkSLp0vre7UtD5QoF_RnXZzYsy4LGB_RKs1wBtfzgcpnVh_mUga-',
    intensity: 'High Intensity, 1-on-1 Custom Focus',
    features: [
      'Custom biomechanics assessment',
  ...
  },
  {
    ...
    icon: 'groups',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuB-FBy4iuo5sjK39j8DNk0-xQ3lTcnWyQZPmGpvdTzienZ9s0u-P9Ku64TdkL6lwJlQjx-VzHm13WLRkmr8S-A2UWkGDJKEWPSTMssuUhSZIGThQuDZ-DhRzKYoCc8NSIhITo4C5zgmb6mK71I4xQsNR8Qc5zROqN0jOTCblVY4zKVMqQtm3GYjiqeGTtrkkLkdOn5fSG4QqWj1Z8qIOz6lIp3gwD0u1u6i6BuSOw005w4xAOhD7kCA',
    intensity: 'Maximum Group Synergy, Athletic HIIT',
    features: [
      '15-athlete max cap',
      'Full functional training circuit',
      'Live coach pacing & form corrections',
  ...
  },
  {
    ...
    description:
      'Unrestricted power release. Industrial environment built for total structural impact.',
    price: 80000,
    priceLabel: 'UGX 80,000 / Session',
    icon: 'sports_baseball',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDNN47XqnTadfSI69GVp84m4zO8UUhv1dGCIYZKqrhzEua9m26nqDsLfUmH1xeVSReWFrJtd4U0iyYKjjGCZG9jrWoUZrsmSU-JtuxhtzTaxyhv_hX4N0j2QBtpMQDOwrJPf67r7aIFuv-Nt2Yq1oAWftPPXkr2M2yftNbhLv9MtqQQqF73RgYL1gvGA_O7WDgWIsPobdrnFkpBVgOBEk3_i4lbMLx_zjWhBRCiu7pB8pPULx3g_JYr',
    intensity: 'Extreme Cathartic Destruction',
    features: [
      'Protective tactical armor provided',
      'Sledgehammers, bats, and steel pipes',
      'Custom audio playlist control',
      'Targeted structural demolition zones',
    ],
  },
  {
    id: 'recovery',
    ...
    features: [
      'Contrast ice & infrared baths',
      'Pneumatic compression boots',
      'Assisted PNF stretching',
      'Guided respiratory reset',
    ],
  },
];
...
export const CLIENT_PROFILES = [
  {
    ...
    phone: '+256 772 458 912',
    avatar:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuD8xMnMorJACf2olTitQUj3TdYcXb3gGMRdqQcVOZaRBvwxazBaLOj6upVDaSQK7JJ-JNgOLUBjF__wL_c5mvT9B9YgTdJr9kvybW3ztzGQbxEJHDytHndniOfspXZv79n6DY0_4B9Q03_gMg1o2pvtVWMH1Vy478VyloWRZ8jzy1yVMGojXYvj4cDJxbYDrSOsam-QUHEyypqoB80boyJXRPRcyDxvGJE2CaJAxcWyUsSZKoTqmpAS',
    tier: 'All-Access Pro',
    sessionsAttended: 42,
  ...
  },
  {
    ...
    phone: '+256 701 834 567',
    avatar:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDJMkVPvVxxSdETfMsuF8tdiH-B7RTNJAcUAV2WwUd0zCq2RNvVNj5gJq5kmiY6HVpoj1uEjNi7lz9ZJ9yZA6kzMjCOAX_AEG5xvjhi6Yd5Xtpq8dgUIQI1FSFzoGXQmEqloj-kJi9LClX5LoMwifcTqnVqNmpZuuhMard6-2xDzYR74kVsg2nWnfVJSPpICksKSlgs8ozMh5Gb5mr6vj37E9EpiD5kVj_E8RnKHt9cuHBQ1BR81gWI',
    tier: '1-on-1 Elite',
    sessionsAttended: 18,
  ...
  },
  {
    ...
    phone: '+256 752 911 340',
    avatar:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuBsgKQD_qsnJM3lkWr2FvDRQMqN4EGt3Ck6XB-yUjFAUXgPpPWHao624Y9aifsdwel64fORN0-b4DvIQCIW5zZAL-4vBf8yJuqhb2t3MA8hQdma2lrLY9tsGKK-iEyQIz3mWzk-B9BBWPVn8K8a49Ogp2Yut3QldBS7Cz5nRr4r8zZuFmSOxiLP259VxlJFicXm44x-RHTfVon2psMFxLvAP_LbpBxXYp99HhK1kyyyHu8qEzXAreHM',
...
export const TIME_SLOTS_BY_DATE: Record<
  string,
  { time: string; spots: number; status: 'available' | 'full'; section: 'morning' | 'evening' }[]
> = {
  default: [
