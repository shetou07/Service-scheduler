...
export default function ContactPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus({
        type: 'success',
        text: 'Thank you — your feedback has been sent. We will get back to you shortly.',
      });
    } catch (error) {
      setStatus({
        type: 'error',
      ...
      <main className="section">
        <div className="container">
          ...
          <p className="contact-intro text-secondary">
            Call, visit, or leave feedback for the Coach Rickie team. Messages go directly to the
            company inbox.
          </p>
          <div className="contact-grid">
            <section className="contact-card cut-corner" aria-labelledby="contact-details-title">
              ...
              <div className="contact-details">
                ...
                <div>
                  <span>Visiting</span>
                  <p>Book a session before visiting so the team can prepare for you.</p>
                </div>
              </div>
              <Link className="button button--secondary cut-corner" href="/book">
                Book a session
              </Link>
            </section>
            <section className="contact-card cut-corner" aria-labelledby="feedback-title">
              ...
              <p className="text-secondary">
                Tell us what you need, ask a question, or share your experience.
              </p>
              <form className="contact-form" onSubmit={submit}>
                ...
                {status && (
                  <p
                    className={status.type === 'error' ? 'form-error' : 'status-message'}
                    role={status.type === 'error' ? 'alert' : 'status'}
                  >
                    {status.text}
                  </p>
                )}
                <button className="button cut-corner" disabled={submitting} type="submit">
